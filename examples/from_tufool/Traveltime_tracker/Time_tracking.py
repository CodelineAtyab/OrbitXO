...
# CONFIGURATION
# -----------------------------
SLACK_WEBHOOK_URL = os.environ.get("SLACK_WEBHOOK_URL")  # Load from env
COOLDOWN_MINUTES = 30  # Minutes between notifications
DATA_FILE = "min_times.json"  
print("SLACK_WEBHOOK:", SLACK_WEBHOOK)
resp = requests.post(SLACK_WEBHOOK, json={"text": message})
print(resp.status_code, resp.text)
# -----------------------------
# Load previous minimum times
# -----------------------------
def load_min_times():
...
last_alert_time = {}  # Stores last notification time per route
...
# -----------------------------
# Main Function to Record Travel Time
# -----------------------------
