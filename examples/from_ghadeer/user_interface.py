...
.btn { display:inline-block; padding: 8px 12px; border-radius: 8px; border: 1px solid #ddd; background: #fff; cursor: pointer; text-decoration:none; }
.btn:hover { background: #f7f7f7; }
.btn-danger { border-color: #f3d1d1; background: #fff5f5; color: #b00020; }
...
.banner { border:1px dashed #9c27b0; background:#f9e6ff; color:#4a148c; padding:10px; border-radius:10px; margin:12px 0; }
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("user_interface:app", host="127.0.0.1", port=8000, reload=True)
