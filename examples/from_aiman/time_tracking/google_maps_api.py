...
if __name__ == "__main__":
    ...
    if result:
        if result["new_minimum"]:
            print("\n:tada: NEW MINIMUM TRAVEL TIME DETECTED!")
            ...
            if result["notification_sent"]:
                print(":white_check_mark: Slack notification sent")
            else:
                print(":information_source: Notification not sent (cooldown active or webhook not configured)")
        else:
